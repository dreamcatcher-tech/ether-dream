...
describe('defunding', () => {
  ...
  it('started defund is ignored in rejected')
  it('reverts for a non-existent change')
  it('non holder cannot defund')
  it('can defund by one of two holders')
  it('can partially defund a change')
  it('can defund to an account with an existing exit debt')
  it('continues defund window after upheld dispute')
})
